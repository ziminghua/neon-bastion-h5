...
await page.screenshot({path:`${out}/scene-build-1600x900.png`});
await page.evaluate(()=>{
...
await page.screenshot({path:`${out}/scene-battle-1600x900.png`});
...
if(!result.ready||result.towers<4||result.assetFailures.length||result.overflow.some(v=>v>0))errors.push(JSON.stringify(result));
